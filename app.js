...
var trivia2Questions = [
  ...
  {
    question:
      "¿Cuál es el elemento químico utilizado para medir el tiempo en los relojes atómicos?",
  ...
  {
    question:
      "¿Cuál es el elemento químico utilizado como combustible en reactores nucleares?",
...
function showResult() {
  ...
  resultElement.innerText =
    "Tu resultado: " + roundedAverage + "% de respuestas correctas";
